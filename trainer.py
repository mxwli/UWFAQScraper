...
model_A = gensim.models.Doc2Vec(documents_Q, vector_size=100, window=8, min_count=5, workers=20, epochs=17, negative=15, sample=1e-5)
...
model_QA = gensim.models.Doc2Vec(documents_Q, vector_size=100, window=8, min_count=5, workers=20, epochs=17, negative=15, sample=1e-5)
